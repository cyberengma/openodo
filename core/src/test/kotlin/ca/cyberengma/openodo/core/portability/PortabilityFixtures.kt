...
internal fun sampleDomain() = PortabilityDomain(
    vehicles = listOf(Vehicle(1,"Africa","Honda","Africa Twin",2021,null,null,DistanceUnit.KILOMETRES,VolumeUnit.LITRES,EnergyUnit.KILOWATT_HOURS,"USD",FuelType.FUEL,Metres(40_000_000),1000,false,"note",1,2)),
    ...
    expenseRecords = listOf(ExpenseRecord(4,1,RecordCategory.SERVICE,LocalDate.of(2026,1,3),Metres(40_100_000),"Oil",PerformedBy.SHOP,"Shop",null,null,null,listOf(ExpenseLineItem(2, Money(5_000, "USD"))),1,2)),
